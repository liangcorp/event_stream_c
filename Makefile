...
all:
	...
	${CC} -Wall -Werror -Wpedantic -g -o ./bin/event_stream ./libs/main.o ./libs/socket_functions.a
...
debug:
	...
	${CC} -fsanitize=address -Wall -Werror -Wpedantic -g -o ./bin/event_stream ./libs/main.o ./libs/socket_functions.a
